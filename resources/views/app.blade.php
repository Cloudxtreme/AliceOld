...
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8">
    <title>Control Panel - {{ App\Setting::find('sitename')->value }}</title>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-body">
                    <div class="col-xs-12 text-center">
                      <a href="/member/charge">{{ App\Setting::find('charge_name')->value }} <span class="label label-success">{{ Auth::user()->charge }}</span></a>
                    </div>
                  </li>
                  <!-- Menu Footer-->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li @if (Request::is('member/charge')) class="active" @endif><a href="/member/charge"><i class="fa fa-money"></i> <span>财务信息</span></a></li>
